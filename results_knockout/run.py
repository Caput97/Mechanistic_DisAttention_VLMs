...
if __name__ == "__main__":
    ...
    ATTN_PER_HEAD = args.attn_per_head
    ...
    mc_data = "/home/dtesta/VLM_interpretability/MAIA_MC_task_Spatial_itempool1_100_eng.json"
    #mc_data = "/home/dtesta/VLM_interpretability/MAIA_MC_task_TemporaleParziale_itempool1_100_eng.json"
    ...
    output_path_prob = (f"/home/dtesta/Mechanistic_DisAttention_VLMs/results_knockout/Attn_knockout_200_16F_{query_scope}_{subdataset}_{video_mode}_mask_{mask_modes_tag}_100EN.jsonl")
    ...
    f"/home/dtesta/Mechanistic_DisAttention_VLMs/results_knockout/"
    f"attn_weights_per_head_200_16F_{query_scope}_{subdataset}_{video_mode}_mask_{mask_modes_tag}.jsonl"
)
    ...
    for idx, item in enumerate(tqdm(data[:100], desc="Processing items")):
        ...
        try:
            ...
            if RUN_MODE == "prob":
                ...
                # 5) Save per-head JSONL (optional) 
                if ATTN_PER_HEAD:
                    item_attn_per_head = {
                        "item": idx + 1,
                        "video_id": video_id,
